...
const getPlayers = (selectedPosition)=>{
  console.log("Selected position:", selectedPosition); // Log the value for debugging  
  const players =
...
players.addEventListener("change", () => {
  playerCards.innerHTML = getPlayers(playerSelect.value);
});
*/
...
headCoach.textContent = headCoach;
