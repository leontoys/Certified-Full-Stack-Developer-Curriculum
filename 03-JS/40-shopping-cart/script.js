...
class ShoppingCart {
    ...
    addItem(id,products){
       ...
       //item added to items array of the cart
       this.items.push(product)
       //for each ice cream - how many items are added to the cart
       ...
       const productExists = currentProductCount > 1 
...
//get all of add to cart buttons
