...
/*   const displayBooks =  books => books.reduce((accumulator,currentValue)=>{
...
const displayBooks = (catalog) => {
                                    ...
                                    catalog.reduce((accumulator,book) => {
  ...
  const filteredBooks = books.filter( book => book.releaseYear > 1975);
